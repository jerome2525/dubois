...
function fx_theme_styles() {
    ...
    fx_assets_add_stylesheet(
        [
            'handle'    => 'masthead-innerpage',
            'src'       => $theme_url . '/assets/css/blocks/innerpage/masthead-innerpage.css',
            'inline'    => true,
        ]
    );
    ...
    fx_assets_add_stylesheet(
        [
            ...
            'src'       => $theme_url . '/assets/css/blocks/homepage/product-image.css',
            'enqueue'   => ( is_404() || has_block( 'acf/recommended-page' ) )
        ]
    );
    ...
    fx_assets_add_stylesheet(
        [
            ...
            'enqueue'       => is_single(), // TODO uncomment if categories in sidebar will use drop-downs. Remove otherwise.
        ]
    );
    ...
    fx_assets_add_stylesheet(
        [
            'handle'        => 'fx_testimonial_inner',
            'src'           => $theme_url . '/assets/css/blocks/homepage/testimonial-block.css',
            'enqueue'       => is_archive()
        ]
    );
...
function fx_theme_scripts() {
    ...
    fx_assets_add_script(
        [
            ...
            'dependencies'  => [ 'fx_choices_plugin' ],
            'defer'         => true,
            'enqueue'       => is_single(), // todo — uncomment and add conditions for dropdowns, etc
        ]
    );     
    ...
    fx_assets_add_script(
        [
            ...
            'dependencies'  => [ 'jquery' ],
            'enqueue'       => has_block( 'acf/homepage-testimonial-block' )
        ]
    );
    ...
    fx_assets_add_script(
        [
            'handle'        => 'fx_testimonial_inner',
            'src'           => $theme_url . '/assets/js/blocks/innerpage/testimonial-list.js',
            'dependencies'  => [ 'jquery' ],
            'enqueue'       => is_archive()
        ]
    );
    ...
    fx_assets_add_script(
        [
            ...
            'dependencies'  => [ 'jquery' ],
            'defer'         => true,
            'enqueue'       => ( has_block( 'acf/testimonial-list' ) || is_archive() )
        ]
    );
    ...
    fx_assets_add_script(
        [
            'handle'        => 'fx_aos_component',
            'src'           => $theme_url . '/assets/js/components/FxAos.js',
            'dependencies'  => [ 'jquery' ],
            'defer'         => true,
            'enqueue'       => ( !is_admin() && !wp_is_mobile() )
        ]
