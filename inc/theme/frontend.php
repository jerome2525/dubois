...
function fx_init() {
    ...
    register_nav_menus(
        array(
            ...
            'top_menu' => 'Navigation items for the top menu.',
            'footer_menu' => 'Navigation items for the footer menu.',
            'copyright_menu' => 'Navigation items for the Copyright menu.',
        )
    );
}
...
/**
 * Use CF7 JS inside wysiwyg Block
 *
 * @param   bool    $register   If true, block assets will be registered
 * @return  bool                If true, block assets will be registered
 */
